...
const StreamlineOperations = () => {
  ...
  return (
    <section className="py-16 md:py-24 relative overflow-hidden bg-enablr-navy">
        ...
        <div className="flex flex-col md:flex-row-reverse items-start justify-between gap-8 md:gap-12">
          <div className="w-full md:w-2/5 md:text-right">
            <motion.h2 
              ...
              className={`${typography.h2} text-white tracking-tight mb-4 text-3xl md:text-4xl`}
            >
              ...
              {items.map((item, index) => (
                ...
                >
                  <div className="p-6 md:p-8 bg-white/10 backdrop-blur-sm rounded-xl shadow-lg border border-white/10 hover:shadow-xl transition-all duration-500 overflow-hidden">
                    ...
                    <div className="absolute bottom-0 right-0 w-32 h-32 bg-gradient-to-bl from-blue-400/10 to-red-400/10 rounded-tl-[80px] -mr-16 -mb-16 opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
                    <div className="absolute top-0 left-0 -ml-12 -mt-12 w-24 h-24 bg-gradient-to-br from-blue-400/10 to-red-400/10 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
