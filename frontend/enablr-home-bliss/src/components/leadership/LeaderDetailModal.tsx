...
const LeaderDetailModal: React.FC<LeaderDetailModalProps> = ({ leader, onClose }) => {
  ...
  return (
    ...
    >
      <div className="bg-white rounded-lg w-full max-w-4xl max-h-[80vh] relative">
        <Button
          variant="ghost"
          size="icon"
        ...
        <div className="p-8 flex flex-col md:flex-row gap-8">
          {/* Fixed image section that doesn't scroll */}
          <div className="md:w-1/4 flex-shrink-0">
            <div className="rounded-lg shadow-md overflow-hidden sticky top-8">
              <img
                src={leader.photoUrl}
                alt={leader.name}
          ...
          <div 
            className="md:w-3/4 overflow-y-auto hide-scrollbar" 
          ...
          >
            ...
            <p className="text-lg text-gray-600 mb-4">{leader.title}</p>
            <div className="text-gray-700 whitespace-normal">{leader.bio}</div>
          </div>
        </div>
      </div>
    </div>
