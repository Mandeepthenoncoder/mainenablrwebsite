...
interface BusinessOperationsSolutionHeroCarouselProps {
  slides: Slide[];
}

const BusinessOperationsSolutionHeroCarousel = ({ slides }: BusinessOperationsSolutionHeroCarouselProps) => {
...
export default BusinessOperationsSolutionHeroCarousel; 