...
/**
 * Workspace Solutions Hero Section
 * Following the design specifications from HeroStylingGuide.md
 */
      ...
      <div className="absolute inset-0 flex items-center z-10">
        <div className="container mx-auto px-4 sm:px-6 md:px-8">
          <div className="max-w-xl">
            ...
            >
              {/* Title with line breaks handling - keeping "Workspace Solutions" on a single line */}
              ...
              <p className="text-base md:text-lg text-white/90 mb-4 md:mb-8 max-w-lg">
                Create future-ready workspaces for your capability center
              </p>
