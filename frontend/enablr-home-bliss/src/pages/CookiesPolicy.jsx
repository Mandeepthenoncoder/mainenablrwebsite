...
const CookiesPolicy = () => {
  return (
    <div className="min-h-screen bg-white flex flex-col">
      <Helmet>
        <title>Cookies Policy | Enablr</title>
        <meta 
          name="description" 
          content="Enablr's cookies policy explains how we use cookies and similar technologies when you visit our website." 
        />
      </Helmet>
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 py-8 flex-grow">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="mb-6">If you have any questions about our Cookie Policy, please contact us at: <a href="mailto:info@enablr.com" className="text-blue-600 hover:underline">info@enablr.com</a></p>
        </div>
      </div>
