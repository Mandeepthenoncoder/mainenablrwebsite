    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 py-8 flex-grow">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="mb-6">To exercise these rights, please contact us at <a href="mailto:info@enablr.com" className="text-blue-600 hover:underline">info@enablr.com</a>.</p>
          ...
          <p className="mb-6">If you have any questions about this Privacy Policy, please contact us: <a href="mailto:info@enablr.com" className="text-blue-600 hover:underline">info@enablr.com</a></p>
        </div>
      </div>
